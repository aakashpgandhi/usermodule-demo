...
<head>
    ...
    <title>Vendors {{ ucfirst($url) }}</title>
...
<!-- Begin page -->
<div class="accountbg" style="height: 100vh;">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="text-center mt-0 m-b-15">
                                    <a href="{{ url('/') }}" class="logo logo-admin"><img src="{{ asset('admin/images/logo.png')}}"  height="150" alt="logo"></a>
                                </h3>
