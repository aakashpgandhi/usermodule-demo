            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5 class="m-1">Vendor @if (isset($vendor)) Edit @else Add
                                @endif
                            </h5>
                        </span>
                        <!-- <span class="pull-right">
                                <a href="{{ route('admin.vendor.index') }}" class="btn btn-primary float-right">Back</a>
                            </span> -->
                    </div>
                    <div class="card-body">
                        @if (isset($vendor))
                            <form action="{{ route('admin.vendor.update', $vendor->id) }}" method="post"
                                enctype="multipart/form-data" class="needs-validation vendor_form" novalidate>
                                @method('PATCH')
                            @else
                                <form action="{{ route('admin.vendor.store') }}" method="post" enctype="multipart/form-data"
                                    class="needs-validation vendor_form" novalidate>
                        @endif
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('business_name', isset($vendor) ? $vendor->business_name : '') }}"
                            ...
                            <div class="form-group col">
                                ...
                                @endif
                                <input type="file"
                                    class="form-control{{ $errors->has('vendor_avatar') ? ' is-invalid' : '' }}"
                                    name="vendor_avatar" id="vendor_avatar"
                                    value="{{ old('vendor_avatar', isset($vendor) ? $vendor->vendor_avatar : '') }}"
                                    {{ $required }}>
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="email"
                                    ...
                                    name="business_email" id="business_email"
                                    value="{{ old('business_email', isset($vendor) ? $vendor->business_email : '') }}"
                            ...
                            <div class="form-group col">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('phone_number', isset($vendor) ? $vendor->phone_number : '') }}"
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control{{ $errors->has('abn_no') ? ' is-invalid' : '' }}"
                                    name="abn_no" id="abn_no"
                                    value="{{ old('abn_no', isset($vendor) ? $vendor->abn_no : '') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control{{ $errors->has('headquarters_address') ? ' is-invalid' : '' }}"
                                name="headquarters_address" id="headquarters_address"
                                value="{{ old('headquarters_address', isset($vendor) ? $vendor->headquarters_address : '') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('store_address') ? ' is-invalid' : '' }}"
                                ...
                                value="{{ old('store_address', isset($vendor) ? $vendor->store_address : '') }}"
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <input type="file"
                                class="form-control{{ $errors->has('registration_document') ? ' is-invalid' : '' }}"
                        ...
                        @if (isset($vendor->registration_document))
                            <div class="form-group col">
                                <img src="{{ $vendor->registration_document }}" width="100px" height="100px"
                                    class="my-3">&nbsp; &nbsp;
                            </div>
                        @endif
                        ...
                        <div class="card-footer text-center">
                            <input type="hidden" name="vendor_id"
                                value="{{ old('vendor_id', isset($vendor) ? $vendor->id : '') }}">
        ...
        $('.vendor_form').validate({
            ...
            messages: {
                ...
                vendor_avatar: {
                    ...
                    // image : "The vendor avatar must be an image.",
                ...
                registration_document: {
                    ...
                    // image: "The registration document must be an image.",
            ...
            //         .closest('.form-group').find('input').removeClass('error').addClass('success');
            // }
        });
