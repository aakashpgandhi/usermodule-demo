                        ...
                        <table width="100%" height="100%" cellpadding="30" cellspacing="0" border="0" style="background-color:#ffffff;">
                            <tr>
                                <td align="left">
                                    ...
                                    <p style="text-align:left; color: #4F687A; font-family: America, sans-serif; position: relative; text-transform: inherit; text-shadow: none; font-size: 1rem; font-weight: 400; line-height: 1.25;">Please Enter Below code to verify your account</p>
                                    <p style="text-align:left; color: #4F687A; font-family: America, sans-serif; position: relative; text-transform: inherit; text-shadow: none; font-size: 1rem; font-weight: 400; line-height: 1.25;">'Your Code is '. <b><h3>{{ $otp }}</h3></b></p>
                                </td>
                            </tr>
                        </table>
                    </td>
